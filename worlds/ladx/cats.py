...
def dumpNyanImage(filename):
    import PIL.Image
    with open('LADXR\\patches\\nyan.bin', 'rb') as f:
        nyan = f.read()
...
with open("LADXR/patches/cats/" + cat_name + ".bin", 'wb') as out:
    with open("LADXR/patches/cats/" + cat_name + ".pal", 'wb') as pal_out:
