...
def link_entrances(world, player):
    ...
    if world.entrance_shuffle[player] == EntranceShuffle.option_vanilla:
        ...
        for exitname, regionname in default_dungeon_connections:
            connect_simple(world, exitname, regionname, player)
    elif world.entrance_shuffle[player] == EntranceShuffle.option_dungeonssimple:
        for exitname, regionname in default_connections:
            connect_simple(world, exitname, regionname, player)

        simple_shuffle_dungeons(world, player)
    elif world.entrance_shuffle[player] == EntranceShuffle.option_dungeonsfull:
        for exitname, regionname in default_connections:
            connect_simple(world, exitname, regionname, player)
    ...
    elif world.entrance_shuffle[player] == EntranceShuffle.option_dungeonscrossed:
        crossed_shuffle_dungeons(world, player)
    elif world.entrance_shuffle[player] == EntranceShuffle.option_simple:
        simple_shuffle_dungeons(world, player)
    ...
    elif world.entrance_shuffle[player] == EntranceShuffle.option_restricted_legacy:
        simple_shuffle_dungeons(world, player)
        ...
        # place remaining doors
        connect_doors(world, single_doors, door_targets, player)
    elif world.entrance_shuffle[player] == EntranceShuffle.option_full:
        skull_woods_shuffle(world, player)
        ...
        # place remaining doors
        connect_doors(world, doors, door_targets, player)
    elif world.entrance_shuffle[player] == EntranceShuffle.option_crossed:
        skull_woods_shuffle(world, player)
    ...
    elif world.entrance_shuffle[player] == EntranceShuffle.option_full_legacy:
        skull_woods_shuffle(world, player)
        ...
        # place remaining doors
        connect_doors(world, single_doors, door_targets, player)
    elif world.entrance_shuffle[player] == EntranceShuffle.option_madness_legacy:
        ...
        # place remaining doors
        connect_doors(world, single_doors, door_targets, player)
    elif world.entrance_shuffle[player] == EntranceShuffle.option_insanity:
        ...
        # place remaining doors
        connect_doors(world, doors, door_targets, player)
    elif world.entrance_shuffle[player] == EntranceShuffle.option_insanity_legacy:
...
def scramble_holes(world, player):
    ...
    if world.entrance_shuffle[player] == EntranceShuffle.option_crossed:
...
def connect_mandatory_exits(world, entrances, caves, must_be_exits, player):
    ...
    if world.logic[player] in ['owglitches', 'hybridglitches', 'nologic']:
        ...
        for entrance in OverworldGlitchRules.get_non_mandatory_exits(world.mode[player] == Mode.option_inverted):
...
def simple_shuffle_dungeons(world, player):
    ...
    if world.mode[player] == Mode.option_open or (world.mode[player] == Mode.option_inverted and world.shuffle_ganon):
    ...
    if world.mode[player] not in [Mode.option_open, Mode.option_inverted] or (world.mode[player] == Mode.option_inverted and world.shuffle_ganon is False):
