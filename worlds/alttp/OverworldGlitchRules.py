...
def no_logic_rules(world, player):
    ...
    """
    create_no_logic_connections(player, world, get_boots_clip_exits_lw(world.mode[player] == Mode.option_inverted))
    create_no_logic_connections(player, world, get_boots_clip_exits_dw(world.mode[player] == Mode.option_inverted, player))

    # Glitched speed drops.
    create_no_logic_connections(player, world, get_glitched_speed_drops_dw(world.mode[player] == Mode.option_inverted))
...
def overworld_glitch_connections(world, player):
    ...
    create_owg_connections(player, world, get_boots_clip_exits_lw(world.mode[player] == Mode.option_inverted))
    create_owg_connections(player, world, get_boots_clip_exits_dw(world.mode[player] == Mode.option_inverted, player))

    # Glitched speed drops.
    create_owg_connections(player, world, get_glitched_speed_drops_dw(world.mode[player] == Mode.option_inverted))
...
def overworld_glitches_rules(world, player):
    ...
    # Boots-accessible locations.
    set_owg_connection_rules(player, world, get_boots_clip_exits_lw(world.mode[player] == Mode.option_inverted), lambda state: can_boots_clip_lw(state, player))
    set_owg_connection_rules(player, world, get_boots_clip_exits_dw(world.mode[player] == Mode.option_inverted, player), lambda state: can_boots_clip_dw(state, player))

    # Glitched speed drops.
    set_owg_connection_rules(player, world, get_glitched_speed_drops_dw(world.mode[player] == Mode.option_inverted), lambda state: can_get_glitched_speed_dw(state, player))
