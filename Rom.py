...
RANDOMIZERBASEHASH = '21dbc71a5e8fe25f855cfdf4695a3986'
...
def patch_enemizer(world, player: int, rom: LocalRom, enemizercli, random_sprite_on_hit):
    ...
    options = {
        ...
        'RandomizeBushEnemyChance': 'random' in world.enemy_shuffle[player],
...
def _populate_sprite_table():
    if not _sprite_table:
        for dir in [local_path(os.path.join("data","sprites","alttpr")), local_path(os.path.join("data","sprites","custom"))]:
